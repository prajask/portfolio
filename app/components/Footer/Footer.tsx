...
const Footer = () => {
	...
	return (
		<footer className="relative w-full bg-texture">
			...
			>
				<div className="pb-8 w-full flex flex-col gap-y-12 lg:gap-y-0 lg:flex-row lg:items-center lg:justify-between border-b border-border-primary/50">
					...
					<div className="self-stretch flex flex-col gap-y-4 justify-end">
						...
						<ul className="flex gap-x-8">
							<li>
								<span className="sr-only text-text-secondary">Next.js</span>
								<SiNextdotjs
									size={16}
							...
							<li>
								<span className="sr-only text-text-secondary">Sanity CMS</span>
								<SiSanity
									size={16}
									color="var(--color-text-secondary)"
								/>
							...
							<li>
								<span className="sr-only text-text-secondary">Tailwind CSS</span>
								<SiTailwindcss
									size={16}
									color="var(--color-text-secondary)"
								/>
							...
							<li>
								<span className="sr-only text-text-secondary">ShadCN UI</span>
								<SiShadcnui
									size={16}
									color="var(--color-text-secondary)"
								/>
...
const _CopyEmailButton = () => {
	...
	return (
		...
		>
			{copiedToClipboard ? (
				<BsCheck2 size={16} color="var(--color-highlight-primary)" />
			) : (
				<BsCopy size={16} color="var(--color-text-secondary)" />
			)}
		</button>
	);
};
